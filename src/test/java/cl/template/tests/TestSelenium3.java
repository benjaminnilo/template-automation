...
public class TestSelenium3 extends BaseConfig {
	
	@Test(dataProvider = "user", dataProviderClass = DataProviders.class, description = "Test 003")
	  public void test001(User user) throws InterruptedException {
	    ...
	    Assert.assertFalse(enterprisePage.validateLogin(), "Login incorrecto falso positivo");
	  }
}